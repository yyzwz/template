...
<div class="loginPage3">
    <Row justify="center" align="middle" @keydown.enter.native="submitLogin" style="height:100%">
        <div class="loginUp">
            <div class="loginLeft">
                <span class="title2">ZWZ</span>
                <span class="line"></span>
                <span class="title">前后端分离开发模版</span>
            </div>
        </div>
                    ...
                    <Row class="loginRow">
                        <Form ref="usernameLoginForm" :model="form" :rules="rules" class="form">
                            <FormItem prop="username" class="loginInput">
                                <Row>
                                    <Input v-model="form.username" size="large" clearable placeholder="请输入您的工号" autocomplete="off">
                            ...
                            <FormItem prop="imgCode">
                                <Row type="flex" justify="space-between" style="align-items: center;overflow: hidden;">
                                    ...
                                    <div class="code-image" style="position:relative;font-size:12px;">
                                        ...
                                        <img :src="captchaImg" @click="getCaptchaImg" alt="加载验证码失败" style="width:110px;cursor:pointer;display:block;height: 50px;" />
                                    </div>
                                </Row>
                            </FormItem>
                        </Form>
                        ...
                        <Button class="login-btn" type="primary" size="large" :loading="loading" @click="submitLogin" long>
                            <span v-if="!loading" style="font-weight:bold">登&emsp;&emsp;录</span>
                            <span v-else>登录中</span>
                        </Button>

                    </Row>
                    <div class="loginBg">
                        <img src="../../assets/login/star.png" alt="" style="width: 100%;">
                    </div>
                </div>
            </div>
        </div>
...
.loginPage3 {
    ...
    .loginBg {
        ...
        margin: 25px auto;
        // margin: 50px;
        // background-image: url(../assets/login/asmx.png);
    ...
    .login-btn {
        width: 190px;
        height: 50px;
        // background: radial-gradient(circle, #A3C0FA, #DDA0DD);
        background: radial-gradient(circle, #a6d0fd, #53f1e7);

        border: 2px solid #A3C0FA;
